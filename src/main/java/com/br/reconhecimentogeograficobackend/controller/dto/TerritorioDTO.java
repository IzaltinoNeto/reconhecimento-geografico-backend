...
public class TerritorioDTO {
    ...
    private TerritorioDTO territorioPai;
    private String cep;
    private String zona;
    ...
    public TerritorioDTO(Territorio territorio) {
        ...
        if(territorio.getTerritorioPai() != null)
            this.territorioPai = new TerritorioDTO(territorio.getTerritorioPai());
    ...
    public TerritorioDTO getTerritorioPai() {
        return territorioPai;
    }

    public void setTerritorioPai(TerritorioDTO territorioPai) {
